    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('ACT', 'Active'), ('SUS', 'Suspended'), ('REM', 'Removed'), ('PEN', 'Pending')], default='PEN', max_length=3)),
                ('invitation_token', models.CharField(blank=True, max_length=32, null=True)),
